 ...
 * [ ] :barber: [Get the header to display channel title and topic nicely](#properties-and-headers). #3aa8811
 * [ ] :moyai: [Compose the necessary components to display a message](#using-components). #2cc20fe
 * [ ] :crystal_ball: [Handle input field state](#state). #089c827
 * [ ] :black_nib: [Send messages to the server](#actions). #05dd82f
